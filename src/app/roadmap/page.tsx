          ...
          <div className="bg-white p-10 border-2 rounded-sm shadow-sm relative overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="space-y-2 text-center md:text-right">
                <h1 className="text-3xl font-black text-slate-900">خارطة الطريق الأكاديمية</h1>
                <p className="text-slate-500 font-bold text-sm leading-relaxed max-w-xl">
                  رحلة منظمة من الصفر إلى الاحتراف في البرمجة التنافسية. اتبع التسلسل لضمان بناء أساس خوارزمي متين وموثق.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
                    ...
                    >
                      <div className="flex items-center gap-6">
                         <div className={cn(
                           ...
                           <span className="text-[10px] font-black uppercase leading-none mb-1">UNIT</span>
            ...
            {stages.length === 0 && (
              <div className="py-32 text-center bg-white border-2 border-dashed rounded-sm">
                 ...
                 <p className="text-slate-300 font-bold text-sm">سيقوم فريق الأكاديمية بإدراج المنهج الجديد خلال الساعات القادمة.</p>
              </div>
            )}
          </div>
        </div>
